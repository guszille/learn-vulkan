...
private:
	...
	bool isDeviceSuitable(VkPhysicalDevice device)
	{
		...
		return deviceProperties.deviceType == VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU && deviceFeatures.geometryShader &&
			queueFamilyIndices.isComplete() && extensionsSupported && swapChainAdequate;
	}
	...
	void createGraphicsPipeline()
	{
		...
		viewportStateInfo.pViewports = nullptr; // Optional
		viewportStateInfo.scissorCount = 1;
		viewportStateInfo.pScissors = nullptr; // Optional
		...
		multisampleStateInfo.minSampleShading = 1.0f; // Optional
		multisampleStateInfo.pSampleMask = nullptr; // Optional
		multisampleStateInfo.alphaToCoverageEnable = VK_FALSE; // Optional
		multisampleStateInfo.alphaToOneEnable = VK_FALSE; // Optional
	...
	void drawFrame()
	{
		...
		vkResetFences(device, 1, &inFlightFences[currentFrame]); // Only reset the fence if we are submitting some work...
